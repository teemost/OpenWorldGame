...
export default function HUD() {
  ...
  return (
    <>
      ...
      {/* ── Interactive buttons (separate from pointer-events:none layer) ── */}
      ...
      {/* Admin dashboard link — only when admin panel open */}
      {isAdmin && showAdmin && (
        <div style={{
          position:'fixed',top:60,left:'50%',transform:'translateX(-50%)',
          width:440,maxHeight:'68vh',overflowY:'auto',zIndex:500,
          ...
          <a
            ...
            style={{
              ...
              borderRadius:8,color:'#ff6600',fontSize:13,marginBottom:16,
              textDecoration:'none',letterSpacing:1,
            }}
          >
            ⚙️ Open Full Admin Dashboard →
          </a>
